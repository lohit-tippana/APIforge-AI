...
// Mounted only while open — fresh state each time, no reset effects.
        ...
        {items.map((item, i) => (
          <button
            ...
            className={cn(
              ...
              i === sel ? "bg-surface-3 text-fg" : "text-fg-muted",
            )}
          >
            ...
            {i === sel && <ArrowRight size={13} className="shrink-0 text-fg-faint" />}
          </button>
        ))}
      </div>
    </DialogPrimitive.Content>
